...
const Films: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 pb-4 border-b border-gray-200 dark:border-gray-700 dark:text-white">All Films</h1>
      
      {films.length === 0 ? (
        <p className="text-gray-500 dark:text-gray-400">No films found.</p>
      ) : (
